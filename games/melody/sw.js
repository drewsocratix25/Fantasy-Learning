...
const ASSETS = [
  ...
  './js/games/songselect.js', './js/games/rhythm.js', './js/games/letters.js', './js/games/numbers.js', './js/games/shapes.js', './js/games/piano.js', './js/games/patterns.js', './js/games/drawing.js',
