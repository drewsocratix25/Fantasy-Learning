...
(function () {
  ...
  // Everything else the narrator says in the studio (listed in voicelines.js so the voice pack can be rendered).
  D.LINES = {
    welcome: 'Welcome to the Art Studio! What would you like to draw? Tap a picture!',
    hint: 'Watch the pencil, then draw it on your paper. You can trace the dotted lines, or draw it your own way!',
    colour: 'Now colour it in! Use any colours you like, then tap Done.',
    remind: 'Now you try! Draw it on your paper on the right.',
    praise: ['Great job!', 'Nice work!', 'Looking good!', 'Wonderful!', 'You did it!', 'Beautiful!'],
    pick: (d) => { const n = d.name.toLowerCase(); return `Let's draw ${/^[aeiou]/.test(n) ? 'an' : 'a'} ${n}!`; },
  };
