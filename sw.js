...
const ASSETS = [
  ...
  './js/save.js', './js/audio.js', './js/songs.js', './js/drawings.js', './js/art.js', './js/ui.js', './js/title.js', './js/world.js',
  './js/games/songselect.js', './js/games/rhythm.js', './js/games/letters.js', './js/games/numbers.js',
  './js/games/shapes.js', './js/games/piano.js', './js/games/patterns.js', './js/games/drawing.js', './js/main.js',
